...
def GET():
    ...
    S1=userbox.get()
    S2=passbox.get()
    if(S1=='anant' and S2=='1234567'):
        menu()
    elif(S1=='sidhu' and S2=='be'):
        menu()
    else:
...
def Entry():
    ...
    bottomframe.pack()
    heading = tkinter.Label(topframe, text="WELCOME TO MATA RANI HOSPITAL",bg='white',fg='orange',font='Times 16 bold italic')
